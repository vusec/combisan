...
//Heinzeen: to make msan return before symbolizing and so.
//          this ensures a fair comparison with CombiSan.
//          remember to use recovery mode
#define MSAN_RETURN_SPEC
