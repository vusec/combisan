...
// CombiSan: gather MSan violation stats
// #define COMBISAN_PROFILING

// CombiSan: only report ASan bugs (without requiring COMBISAN_BENCH_LOWER)
#define COMBISAN_DEBUG_ASAN
