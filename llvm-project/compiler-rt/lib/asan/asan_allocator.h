...
void *asan_memalign(uptr alignment, uptr size, BufferedStackTrace *stack,
                    AllocType alloc_type, bool set_init = true);
void asan_free(void *ptr, BufferedStackTrace *stack, AllocType alloc_type);
void asan_delete(void *ptr, uptr size, uptr alignment,
                 BufferedStackTrace *stack, AllocType alloc_type);

void *asan_malloc(uptr size, BufferedStackTrace *stack, bool set_init = true);
void *asan_calloc(uptr nmemb, uptr size, BufferedStackTrace *stack, bool set_init = true);
void *asan_realloc(void *p, uptr size, BufferedStackTrace *stack, bool set_init = true);
void *asan_reallocarray(void *p, uptr nmemb, uptr size,
                        BufferedStackTrace *stack, bool set_init = true);
void *asan_valloc(uptr size, BufferedStackTrace *stack, bool set_init = true);
void *asan_pvalloc(uptr size, BufferedStackTrace *stack, bool set_init = true);

void *asan_aligned_alloc(uptr alignment, uptr size, BufferedStackTrace *stack, bool set_init = true);
