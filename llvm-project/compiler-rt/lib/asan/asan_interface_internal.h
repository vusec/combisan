...
extern "C" {
  ...
  SANITIZER_INTERFACE_ATTRIBUTE void __combisan_initialize(uptr p, uptr size);
  ...
  SANITIZER_INTERFACE_ATTRIBUTE void* asan_malloc_uninit(uptr size);
  SANITIZER_INTERFACE_ATTRIBUTE void* asan_calloc_uninit(uptr nmemb, uptr size);
  SANITIZER_INTERFACE_ATTRIBUTE void *asan_realloc_uninit(void *p, uptr size);
  SANITIZER_INTERFACE_ATTRIBUTE void* asan_reallocarray_uninit(void *ptr, uptr nmemb, uptr size);
  SANITIZER_INTERFACE_ATTRIBUTE void* asan_memalign_uninit(uptr boundary, uptr size);
  SANITIZER_INTERFACE_ATTRIBUTE void* asan___libc_memalign_uninit(uptr boundary, uptr size);
  SANITIZER_INTERFACE_ATTRIBUTE void* asan_aligned_alloc_uninit(uptr boundary, uptr size);
  SANITIZER_INTERFACE_ATTRIBUTE int asan_posix_memalign_uninit(void **memptr, uptr alignment, uptr size);
  SANITIZER_INTERFACE_ATTRIBUTE void* asan_valloc_uninit(uptr size);
  SANITIZER_INTERFACE_ATTRIBUTE void* asan_pvalloc_uninit(uptr size);
  SANITIZER_INTERFACE_ATTRIBUTE void *asan_new_uninit(size_t size);
  SANITIZER_INTERFACE_ATTRIBUTE void *asan_new_arr_uninit(size_t size);
  SANITIZER_INTERFACE_ATTRIBUTE void *asan_new_thr_uninit(size_t size, std::nothrow_t const&);
  SANITIZER_INTERFACE_ATTRIBUTE void *asan_new_thr_arr_uninit(size_t size, std::nothrow_t const&);
  SANITIZER_INTERFACE_ATTRIBUTE void *asan_new_aln_uninit(size_t size, std::align_val_t align);
  SANITIZER_INTERFACE_ATTRIBUTE void *asan_new_arr_aln_uninit(size_t size, std::align_val_t align);
  SANITIZER_INTERFACE_ATTRIBUTE void *asan_new_thr_aln_uninit(size_t size, std::align_val_t align, std::nothrow_t const&);
  SANITIZER_INTERFACE_ATTRIBUTE void *asan_new_thr_aln_arr_uninit(size_t size, std::align_val_t align, std::nothrow_t const&);
