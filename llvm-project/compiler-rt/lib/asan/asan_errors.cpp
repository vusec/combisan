...
static void PrintLegend(InternalScopedString *str) {
  ...
  PrintShadowByte(str, "  Addressable (valid):\t\t", 0);
#if 1 // CombiSan legend
  PrintShadowByte(str, "  Fully redzone:\t\t", kCombiASanRZ);
  PrintShadowByte(str, "  Fully uninitialized:\t\t", kCombiMSanUn);
  PrintShadowByte(str, "  1 valid 3 redzone:\t\t", kCombiASan13);
  PrintShadowByte(str, "  2 valid 2 redzone:\t\t", kCombiASan22);
  PrintShadowByte(str, "  3 valid 1 redzone:\t\t", kCombiASan31);
  PrintShadowByte(str, "  1 uninit 3 redzone:\t\t", kCombiMSan13);
  PrintShadowByte(str, "  2 uninit 2 redzone:\t\t", kCombiMSan22);
  PrintShadowByte(str, "  3 uninit 1 redzone:\t\t", kCombiMSan31);
  PrintShadowByte(str, "  1 valid 3 uninit:\t\t", kCombiMSanValid13);
  PrintShadowByte(str, "  2 valid 2 uninit:\t\t", kCombiMSanValid22);
  PrintShadowByte(str, "  3 valid 1 uninit:\t\t", kCombiMSanValid31);
#else
